...
for score, box, class_ in zip(scores, boxes, classes):
    ...
    cv2.rectangle(img_padded, (min_x, min_y), (max_x, max_y), color, 5)
    ...
    cv2.rectangle(img_padded,
                  ...
                  color, cv2.FILLED) 
    cv2.putText(img_padded, label, (min_x, min_y), cv2.FONT_HERSHEY_SIMPLEX, LABEL_SIZE, text_color, 3)
